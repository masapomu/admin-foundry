...
const colors=[['primary text','#24282f','#ffffff'],['muted text','#626b77','#f7f8f9'],['primary action','#ffffff','#315fbd'],['danger action','#ffffff','#b3363d'],['success','#23704c','#edf7f1'],['warning','#885613','#fff7e8'],['danger','#b3363d','#fdf0f0'],['info','#31688d','#eef6fb'],['soft blue theme on white','#365c82','#ffffff'],['soft blue selection','#365c82','#dce7f1'],['muted red theme on white','#86515a','#ffffff'],['muted red selection','#86515a','#f0e2e5'],['dark primary text','#edf2f7','#20262e'],['dark secondary text','#bdc9d5','#20262e'],['dark muted text','#aab7c4','#15191f'],['dark accent','#91b8e8','#20262e'],['dark selection','#91b8e8','#31445b'],['dark active page','#15191f','#91b8e8'],['dark primary action','#ffffff','#446fa6'],['dark danger action','#ffffff','#a53442'],['dark success','#89d5ad','#203a2d'],['dark warning','#e6bf79','#413220'],['dark danger','#f08e94','#42262b'],['dark info','#87c9e3','#203644']];
