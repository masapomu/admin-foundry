...
for(const file of ['assets/js/admin-ui.js','assets/js/reference-demo.js']){
...
const colors=[['primary text','#24282f','#ffffff'],['muted text','#626b77','#f7f8f9'],['primary action','#ffffff','#315fbd'],['danger action','#ffffff','#b3363d'],['success','#23704c','#edf7f1'],['warning','#885613','#fff7e8'],['danger','#b3363d','#fdf0f0'],['info','#31688d','#eef6fb']];
...
console.log(`PASS: ${files.length} pages, ${references} local references, IDs/ARIA/input labels, offline assets, vendor materials, 8 text contrast pairs.`);
